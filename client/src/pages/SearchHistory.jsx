...
const SearchHistory = () => {
    ...
    useEffect(() => {
        const getSearchHistory = async () => {
            setLoading(true)
            try {
                const response = await axios.get(`/v1/search/history`)
    ...
    const handleDelete = async(entry) => {
       try {
        await axios.delete(`/v1/search/history/${entry?.id}`)
        ...
        return (
            <div className="bg-black min-h-screen text-white">
                ...
                <div className="max-w-6xl mx-auto px-4 py-8">
                    <p className="text-3xl font-bold mb-8">Search History</p>
                       ...
                       {SearchHistory.map((entry) => (
                         ...
                         >
                           ...
                           <div className="flex flex-col">
                             ...
                             <span className="text-gray-400 text-sm">{formateDate(entry.createdAt)}</span>
                           </div>
                           <span
